...
type Props = {
  ...
  isLoading?: boolean;
  onError?: QRL<(e: any) => string | number | void>;
...
const ChatMessage = component$<Props>((props) => {
  ...
  return (
    <div class="mb-8 group">
      ...
      <AutosizeTextarea value={props.message.content} fullHeight={true} onChange={props.onChange} onKeyDown={$((e) => {
        if (
          e.key === 'Enter' &&
          !e.shiftKey &&
